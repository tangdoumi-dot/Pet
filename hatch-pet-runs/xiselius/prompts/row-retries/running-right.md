Create Codex pet row `running-right` for `xiselius`: exactly 8 full-body frames in one horizontal strip on flat pure cyan #00FFFF.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: 同一个西塞留斯形象：Q版二头身像素风少年，蓬松白发，金色眼睛，单侧金色坠饰耳环，深蓝衬衫，深色裤子，棕色披风外套，慵懒傲娇、冷淡温柔、毒舌但可爱。动作幅度轻微、柔软、慢动作。. Preserve silhouette, face, palette, material, proportions, markings, and props.
